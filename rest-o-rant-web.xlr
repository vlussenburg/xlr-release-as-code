// Exported from:        http://4011f63d1886:5516/#/templates/Release00000002/xfile
// XL Release version:   7.0.1
// Date created:         Thu Jul 20 14:33:48 GMT 2017
...
xlr {
  release('Release rest-o-rant-web') {
    variables {
        ...
        tasks {
          custom('Deploy to production') {
            ...
            script {
              ...
              server server1
              deploymentPackage 'rest-o-rant-web/${version}'
